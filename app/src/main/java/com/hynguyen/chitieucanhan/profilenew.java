...
//                break;
//        }
        if (v.getId() == R.id.txtdiachi) {
            DiaLog(3);
        } else if (v.getId() == R.id.txthoten) {
            DiaLog(1);
        } else if (v.getId() == R.id.txtsdt) {
            DiaLog(2);
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        if (requestCode == 123 && resultCode == RESULT_OK) {
            ...
            try {
                ...
                storageReference = FirebaseStorage.getInstance("gs://chitieucanhan-c4490.appspot.com/").getReference();

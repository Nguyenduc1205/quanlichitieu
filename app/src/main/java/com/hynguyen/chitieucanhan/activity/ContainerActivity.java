...
//                }
                if (item.getItemId() == R.id.menuHome) {
                    ...
                    txtTBTitle.setText("Báo cáo");
                    showButtonThemThuChi();
                } else if (item.getItemId() == R.id.menuThuNhap) {
                    vpContaner.setCurrentItem(1);
                    txtTBTitle.setText("Thu chi");
                    showButtonThemThuChi();
                } else if (item.getItemId() == R.id.menuCaiDat) {
                    vpContaner.setCurrentItem(2);
                    txtTBTitle.setText("Cài đặt");
                    hideButtonThemThuChi();
                }
...
//
//                }
                if (item.getItemId() == R.id.danhmuc) {
                    fm = new pprofile3();
                } else if (item.getItemId() == R.id.dangnhap) {
                    startActivity(new Intent(ContainerActivity.this, home.class));
                }
                if(fm!=null){

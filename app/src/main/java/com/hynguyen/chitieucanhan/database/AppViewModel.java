...
public class AppViewModel extends AndroidViewModel {
    ...
    public LiveData<List<ChiTieu>> tatCaChiTieuTheoNgay(long ngay) {
        for (ChiTieu chiTieu : tatCaChiTieu.getValue()) {
            Calendar calendar = Calendar.getInstance();
            calendar.setTime(chiTieu.getDate());

            if (chiTieu.getDate().getTime() == ngay) {
                return tatCaChiTieu;
            }
        }
        return tatCaChiTieu;
